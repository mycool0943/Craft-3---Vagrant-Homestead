...
namespace roundhousefocuspoint\focuspoint;
 ...
 * @since     1.0.0
 */
class Focuspoint extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'focuspoint/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'focuspoint/default/do-something';
            }
        );
 ...
 */
        Craft::info('Focuspoint ' . Craft::t('focuspoint', 'plugin loaded'), __METHOD__);
    }
