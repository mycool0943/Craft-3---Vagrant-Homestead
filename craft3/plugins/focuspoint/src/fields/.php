...
namespace roundhousefocuspoint\focuspoint\fields;

use roundhousefocuspoint\focuspoint\Focuspoint;
use roundhousefocuspoint\focuspoint\assetbundles\field\FieldAsset;
...
class  extends Field
{
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').Focuspoint(" . $jsonVars . ");");
